...
CREATE TABLE `borrows` (
                           `id` INT(20) NOT NULL AUTO_INCREMENT,
                           `s_id` INT(20) DEFAULT NULL,   -- 学生ID (来自 students.id)
                           `b_id` INT(20) DEFAULT NULL,   -- 书籍ID (来自 books.id)
                           `status` VARCHAR(20) NOT NULL, -- 关键状态: 'pending', 'approved', 'denied', 'returned'
                           `request_date` DATETIME DEFAULT CURRENT_TIMESTAMP, -- 申请日期
                           `approval_date` DATETIME DEFAULT NULL, -- 审批/拒绝日期
                           `return_date` DATETIME DEFAULT NULL,   -- 归还日期
                           PRIMARY KEY (`id`),
    -- 添加外键约束以保证数据完整性
...
insert  into `students`(`id`,`user`,`password`,`name`,`grade`,`classes`,`email`,`amount`,`is_locked`) values

                          (8,'20200002','123','李四','2020','网工一班','456@qq.com',2,0),

                          (10,'20200005','123','张三','2020','数媒二班','456@qq.com',1,0),

                          (11,'20240001','123456','王五','2024','软件工程1班','1231321@qq.com',0,0),

                          (12,'20240002','123456','李丽丽','2024','软件测试1班','12313@qq.com',0,0),

                          (13,'2024003','123456','丘陵','2024','附件阿斯蒂芬','213131',0,0);
