...
public class DBAccess {
	...
	private String url = "jdbc:mysql://localhost:3306/online_library?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
	...
	public void query(String sql) {//查询结果集
		try {
			stm = conn.createStatement();
