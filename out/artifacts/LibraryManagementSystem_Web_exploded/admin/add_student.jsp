...
<div class="register-container">
    <div class="register-card">
        <div class="register-header">
            <h2><i class="bi bi-person-plus"></i> 添加学生信息</h2>
        </div>

        <div class="register-body">
            <form action="../manageStudentServlet.do?action=addstudent" method="post" name="form3" id="addStudentForm">
                ...
                <div class="row form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="relpwd" class="form-label">确认密码</label>
                        <input type="password" class="form-control" id="relpwd" name="relpwd" placeholder="请再次输入密码" required>
                ...
                <button type="submit" class="btn btn-primary submit-btn">
                    <i class="bi bi-person-check"></i> 添加学生
                </button>
            </form>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const relpwd = document.getElementById('relpwd');
        const passwordMatch = document.getElementById('passwordMatch');

        function validatePassword() {
            if (password.value === '' || relpwd.value === '') {
                passwordMatch.textContent = '';
                passwordMatch.className = 'password-match';
            } else if (password.value === relpwd.value) {
        ...
        relpwd.addEventListener('input', validatePassword);
